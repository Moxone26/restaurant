...
class Database
{
	...
	public function __construct()
	{
		...
		(
			...
			[
	            PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, // transformer les erreurs en exceptions
	            PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC // par défaut on récupére les résultats de requête SELECT dans des tableaux associatifs
	        ]
		);
